Приложение доступно по адресу: https://uchihack-poznavalki.web.app. Для рабрты поиска необходимо выключить cors в браузере (рекомендуется запускать в хромн)
